...
static T_DjiCameraSpotMeteringTarget s_cameraSpotMeteringTarget = {};

static E_DjiCameraFocusMode s_cameraFocusMode = DJI_CAMERA_FOCUS_MODE_AUTO;
static T_DjiCameraPointInScreen s_cameraFocusTarget = {};
static uint32_t s_cameraFocusRingValue = FOCUS_MID_RINGVALUE;
static T_DjiCameraFocusAssistantSettings s_cameraFocusAssistantSettings = {};
...
static T_DjiCameraTapZoomState s_cameraTapZoomState = {};
...
static T_TestCameraGimbalRotationArgument s_tapZoomNewestGimbalRotationArgument = {};
...
{
    T_DjiReturnCode returnCode;
    T_DjiAircraftInfoBaseInfo aircraftBaseInfo = {};
...
/* Private functions definition-----------------------------------------------*/
T_DjiReturnCode DjiTest_CameraEmuBaseStartServiceTask(void)
{
    T_DjiReturnCode returnCode;
